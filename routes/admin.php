...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    //Top Up Game
    Route::controller(TopUpGameController::class)->prefix('top-up-game')->name('top.up.game.')->group(function () {
        Route::get('index', 'index')->name('index');
    ...
    //Top Up Logs
    Route::controller(TopUpLogController::class)->prefix('top-up')->name('top.up.log.')->group(function () {
        Route::get('index', 'index')->name('index');
        Route::get('review/payment', 'reviewPayment')->name('review.payment');
        Route::get('pending', 'pending')->name('pending');
        Route::get('confirm/payment', 'confirmPayment')->name('confirm.payment');
        ...
        Route::get('refunded', 'refunded')->name('refunded');
        Route::get('delayed', 'delayed')->name('delayed');
        Route::get('details/{id}', 'topUpDetails')->name('details');
        Route::put('status/update/{id}', 'statusUpdate')->name('status.update');

...
Route::name('user.')->group(function () {
    ...
    Route::post('register/submit', [UserRegisterController::class, "register"])->name('register.submit')->middleware(['user.registration.permission']);
    ...
    Route::controller(AuthorizationController::class)->prefix("authorize")->name('authorize.')->middleware("auth")->group(function () {
        ...
        Route::get('mail/resend/{token}', 'mailResend')->name('mail.resend')->middleware(['user.registration.permission']);

...
class TopUpLogs extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        return [
            ...
            'excharge_rate'    => $this->payment_gateway_currency_id == null ? "N/A": getAmount($this->currency->rate, 2) . ' ' .  $this->currency->currency_code,
